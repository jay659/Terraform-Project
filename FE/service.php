...
<main>
         ...
         <div class="row align-items-center">
            <div class="col-lg-6">
               <div class="tp-service-breadcrumb-title-wrapper">
                  ...
                  <h3 class="tp-section-title">Best Digital <span class="title-color">Technology</span> <br> Agency For
                     People
                  </h3>
               </div>
            </div>
         ...
         <div class="row1">
            <div class="col-xl-3 col-lg-3 col-md-6">
               <div class="tp-service-3-content breadcrumb-item mb-30">
                  ...
                  <p>Power up your projects with scalable processing</p>
   ...
   <!-- blog area start -->
   <section class="tp-blog-3-area p-relative fix pb-100">
            ...
            <div class="col-xl-4 col-md-6">
               <div class="tp-blog-3-wrapper mb-30 OneByOne">
                  ...
                  <div class="tp-blog-3-content">
                     ...
                     <h3 class="tp-blog-3-title"><a href="blog-details.php">Providing solutions for Industrial <br>
                           men, and restoration.</a></h3>
                  </div>
                  <div class="tp-blog-3-btn d-flex justify-content-between">
                     <div class="read-more p-relative">
                        <a href="blog-details.php">Read More <span><svg width="21" height="19" viewBox="0 0 21 19"
            ...
            <div class="col-xl-4 col-md-6">
               <div class="tp-blog-3-wrapper mb-30 OneByOne">
                  ...
                  <div class="tp-blog-3-content">
                     ...
                     <h3 class="tp-blog-3-title"><a href="blog-details.php">Everything melancholy uncommonly but
                           solicitude.</a></h3>
                  </div>
                  <div class="tp-blog-3-btn d-flex justify-content-between">
                     <div class="read-more p-relative">
            ...
            <div class="col-xl-4 col-md-6">
               <div class="tp-blog-3-wrapper mb-30 OneByOne">
                  ...
                  <div class="tp-blog-3-content">
                     ...
                     <h3 class="tp-blog-3-title"><a href="blog-details.php">Discovery incommode earnestly commanded
                           mentions.</a></h3>
                  </div>
                  <div class="tp-blog-3-btn d-flex justify-content-between">
                     <div class="read-more p-relative">
