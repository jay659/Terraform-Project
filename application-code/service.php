         ...
         <div class="row1">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6">
               <div class="tp-service-3-content breadcrumb-item mb-30">
                  ...
                  <h4 class="tp-service-breadcrumb-title"><a href="service-details2.php">Cloud object Storage</a></h4>
                  <p>Store, access, and share seamlessly with our cloud storage </p>
                  <div class="tp-service-btn">
                     <a href="service-details.php">Read More <i class="fa-solid fa-arrow-up-right"></i></a>
                  </div>
               </div>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6">
               <div class="tp-service-3-content breadcrumb-item mb-30">
                  ...
                  <h4 class="tp-service-breadcrumb-title"><a href="service-details3.php">Private Cloud</a></h4>
                  <p>Your customized, secure cloud environment for ultimate control </p>
                  <div class="tp-service-btn">
                     <a href="service-details.php">Read More <i class="fa-solid fa-arrow-up-right"></i></a>
                  </div>
               </div>
